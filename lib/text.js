...
const ingfo = `This bot is built in the Node.js / JavaScript programming language
Bot source code: Just check on my github profile *[https://github.com/kizzajamie]* their many bot projects,
Most of them are private for the mean time use the public repos
...
const mess = {
			 ...
			 limit: 'Your usage limit has run out\n\nNote: the limit will be reset every time 00.00',
